...
{
    public class NoticeAreaCacheService : BaseHandlerCacheService, INoticeAreaCacheService
    {
        private readonly IYCacheFactory _factory;
        public NoticeAreaCacheService(IOptionsMonitor<YCacheConfiguration> options, IYCacheFactory factory)
        {
