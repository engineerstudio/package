...
{
    public class MerchantCacheService : BaseHandlerCacheService, IMerchantCacheService
    {
        private readonly IYCacheFactory _factory;
        public MerchantCacheService(IOptionsMonitor<YCacheConfiguration> options, IYCacheFactory factory)
        {
