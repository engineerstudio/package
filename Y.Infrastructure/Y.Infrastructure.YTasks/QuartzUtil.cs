...
namespace Y.Infrastructure.YTasks
{
    public class QuartzUtil
    {
        ...
        /// <param name="SimpleTime">毫秒数</param>
        /// <returns></returns>
        public async Task<DateTimeOffset> AddJob<T>(string JobName, DateTimeOffset StartTime, int SimpleTime) where T : IJob
        {
        ...
        /// <returns></returns>
        public async Task<DateTimeOffset> AddJob<T>(string JobName, DateTimeOffset StartTime, TimeSpan SimpleTime) where T : IJob
        {
        ...
        /// <param name="jobDataMap"></param>
        /// <returns></returns>
        public async Task<DateTimeOffset> AddJob<T>(string JobName, DateTimeOffset StartTime, int SimpleTime, string MapKey, object MapValue) where T : IJob
        {
        ...
        /// <param name="jobDataMap"></param>
        /// <returns></returns>
        public async Task<DateTimeOffset> AddJob<T>(string JobName, DateTimeOffset StartTime, TimeSpan SimpleTime, Dictionary<string, object> map) where T : IJob
        {
