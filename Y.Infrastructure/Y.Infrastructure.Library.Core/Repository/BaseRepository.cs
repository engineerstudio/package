...
namespace Y.Infrastructure.Library.Core.Repository
{
    public class BaseRepository<T, TKey> : IBaseRepository<T, TKey> where T : class
    {
        ...
        public T Get(string conditions, object parameters = null) =>
            _dbConnection.QueryFirstOrDefault<T>(conditions, parameters);
        ...
        public int DeleteList(string conditions, object parameters = null, IDbTransaction transaction = null,
        ...
        public Task<T> GetAsync(string conditions, object parameters = null) =>
            _dbConnection.QueryFirstOrDefaultAsync<T>(conditions, parameters);
        ...
        public Task<IEnumerable<T>> GetListPagedAsync(int pageNumber, int rowsPerPage, string conditions,
        ...
        public Task<int> DeleteListAsync(object whereConditions, IDbTransaction transaction = null,
            int? commandTimeout = null)
        {
            return _dbConnection.DeleteListAsync<T>(whereConditions, transaction, commandTimeout);
        }

        public Task<int> DeleteListAsync(string conditions, object parameters = null, IDbTransaction transaction = null,
            int? commandTimeout = null)
        {
