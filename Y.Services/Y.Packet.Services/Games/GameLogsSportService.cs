...
{
    public class GameLogsSportService : IGameLogsSportService
    {
        private readonly IGameLogsSportRepository _repository;

        public GameLogsSportService(IGameLogsSportRepository repository)
        {
            _repository = repository;
        }

        public async Task<bool> AddSportLog(GameLogsSport logs)
        {
            try
            {
                ...
                logs.CreateTime = dt;
                logs.UpdateTime = dt;
                var rt = await _repository.InsertAsync(logs);
        ...
        public async Task<bool> UpdateSportLog(GameLogsSport log)
        {
