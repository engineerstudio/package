...
{
    public class GameDicRepository:BaseRepository<GameDic,Int32>, IGameDicRepository
    {
        public GameDicRepository(IOptionsMonitor<DbOption> options)
        {
        ...
        {
            string sql = "update GameDic set IsDelete=1 where Id in @Ids";
