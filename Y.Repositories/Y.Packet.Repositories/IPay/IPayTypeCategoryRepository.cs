...
*│　接口名称： IPayTypeCategoryRepository                                      
*└──────────────────────────────────────────────────────────────┘
*/
using System;
...
{
    public interface IPayTypeCategoryRepository : IBaseRepository<PayTypeCategory, Int32>
    {
        /// <summary>
        /// 逻辑删除返回影响的行数
        /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        Task<PayTypeCategory> GetAsync(int merchantId, int id);
    }
}