...
{
    public interface IPayCategoryRepository : IBaseRepository<PayCategory, Int32>
    {
        /// <summary>
        /// 逻辑删除返回影响的行数
        /// </summary>
        ...
        Task<PayCategory> GetFromCacheAsync(int id);
        Task<int?> InsertWithCacheAsync(PayCategory entity);
        Task<int> UpdateWithCacheAsync(PayCategory entity);
