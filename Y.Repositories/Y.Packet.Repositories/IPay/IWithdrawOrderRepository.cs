...
{
    public interface IWithdrawOrderRepository : IBaseRepository<WithdrawOrder, Int32>
    {
        /// <summary>
        /// 逻辑删除返回影响的行数
        /// </summary>
        ...
        /// <returns></returns>
        Task<WithdrawOrder> GetFirstFindishedOrderAsync(int userId);
        ...
        /// <returns></returns>
        Task<WithdrawOrder> GetAsync(int merchantId, int orderId);
    }
}