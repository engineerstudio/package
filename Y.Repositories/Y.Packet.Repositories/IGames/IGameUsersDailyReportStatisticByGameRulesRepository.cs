...
*│　接口名称： IGameUsersDailyReportStatisticByGameRulesRepository                                      
*└──────────────────────────────────────────────────────────────┘
*/
using System;
...
{
    public interface IGameUsersDailyReportStatisticByGameRulesRepository : IBaseRepository<GameUsersDailyReportStatisticByGameRules, Int32>
    {
	     /// <summary>
        /// 逻辑删除返回影响的行数
        /// </summary>
