...
{
    public interface IGameDailyReportStatisticRepository : IBaseRepository<GameDailyReportStatistic, Int32>
    {
        /// <summary>
        /// 逻辑删除返回影响的行数
        /// </summary>
        ...
        /// <returns></returns>
        Task<IEnumerable<GameDailyReportStatistic>> GetAsync(int merchantId, int category, string typeStr, DateTime startTime, DateTime endTime);
    }
}