...
*│　接口名称： IGameDailyReportStatisticByGameRulesRepository                                      
*└──────────────────────────────────────────────────────────────┘
*/
using System;
...
{
    public interface IGameDailyReportStatisticByGameRulesRepository : IBaseRepository<GameDailyReportStatisticByGameRules, Int32>
    {
	     /// <summary>
        /// 逻辑删除返回影响的行数
        /// </summary>
