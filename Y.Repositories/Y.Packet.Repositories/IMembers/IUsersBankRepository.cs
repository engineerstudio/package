...
{
    public interface IUsersBankRepository : IBaseRepository<UsersBank, Int32>
    {
        /// <summary>
        /// 逻辑删除返回影响的行数
        /// </summary>
        ...
        Task<UsersBank> GetFromCacheAsync(int id);
        Task<Int32?> InsertWithCacheAsync(UsersBank userBank);
        Task<IEnumerable<UsersBank>> GetUsersBanksAsync(int merchantId, int memberId);
